...
const images = [
 ...
 galleryListEl.addEventListener("click", (event) => {
   ...
   // console.log(galleryImgEl.dataset.source);
 
   const modalImgEl = basicLightbox.create(`
     <img
       src="${galleryImgEl.dataset.source}"
       alt="${galleryImgEl.alt}"
     />`);
